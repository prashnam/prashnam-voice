...
The script creates a venv, installs dependencies, launches the local server at `http://127.0.0.1:8765`, and opens the setup wizard in your browser. Model weights download once from public mirrors at [`huggingface.co/naklitechie/*`](https://huggingface.co/naklitechie); everything runs offline after that.
